  ...
  return (
    <div className="table-responsive">
      <table className="table table-hover table-sm table-bordered table-striped">
        <thead>
          <tr>
            <th className="text-center">Numero_Catastral</th>
            <th className="text-center">Ubicacion</th>
            <th className="text-center">Zona</th>
            <th className="text-center">Tipo</th>
            <th className="text-center">Numero_Contribuyente</th>
            <th className="text-center">FechaRegCatastro</th>
          ...
          {Items &&
            Items.map((Item) => (
              <tr key={Item.Numero_Catastral}>
                ...
                {Item.Numero_Contribuyente}
                </td>
                <td className="text-center">
                {Item.FechaRegCatastro}
                </td>
